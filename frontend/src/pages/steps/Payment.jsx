  ...
  return (
    <div className="grid grid-cols-2 gap-8 p-6 relative">
      ...
      <div className="relative">
        <div className="w-[350px] h-full bg-[#d5e4fa] rounded-2xl">
          <div className="grid grid-cols-1 gap-2 text-center">

            <img src={background2} alt="" className="w-full h-[150px] rounded-t-2xl" />
            ...
            <div className='relative -top-10'>
              <h1 className="text-xl font-semibold">Camping: Amazon Jungle</h1>
              <h3 className="text-lg text-[#021F86]">With Maria</h3>
              ...
              <div className="p-8">
                ...
                <div className="mt-6">
                  <button className="bg-blue-500 text-white text-lg font-semibold px-24  p-2 hover:bg-blue-300 rounded-full">Pay Now</button>
                </div>
              </div>
            </div>
