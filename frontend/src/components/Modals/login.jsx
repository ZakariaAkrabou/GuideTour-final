      ...
      <div className="fixed inset-0 z-50 overflow-x-hidden overflow-y-auto outline-none focus:outline-none flex justify-center items-center">
        <div className="relative flex flex-col bg-white shadow-2xl rounded-2xl md:flex-row md:space-y-0 ">
          ...
          >
            ...
            <span className="mb-2 font-light text-gray-400 text-sm">
            ...
            <div className="py-4">
              ...
              <div className=" flex items-center justify-center">
                ...
                <a href="" className="text-blue-500 hover:underline cursor-pointer hover:text-black" onClick={() => setShowModal(false)} >
                  Register
                </a>
              </div>
            </div>
          ...
          <div className="relative">
            <img
              ...
              alt="img"
              className="w-[300px] h-[450px] hidden rounded-r-2xl md:block object-cover"
            />
          </div>
        </div>
      </div>
