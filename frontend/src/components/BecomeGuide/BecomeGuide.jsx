          ...
          <div className="lg:w-[300px] h-[530px] flex flex-col bg-[#e5edfa] rounded-2xl p-2">
            <div className="lg:grid lg:grid-cols-1 gap-2 text-center">
              ...
              <div className='flex flex-col items-start gap-1'>
                ...
                <div className='w-full flex'>
                  <input type="text" placeholder='Specialization' className='w-full border-[1.5px] pl-8 border-gray-400 rounded-lg'/>
                  <MdWork size={20} className='absolute translate-y-3 ml-2 text-gray-400'/>
                </div>
                <div className='w-full '>
                  <span>Upload your Identity file here</span>
                  <input type="file" className='w-full border-[1.5px]   border-gray-400 rounded-lg'/>
                </div>
                <div className='w-full '>
              ...
              <div className=''>
                <button className=' font-semibold text-white hover:scale-x-110 bg-primary rounded-full px-10 p-1'>
                  Switch
                </button>
              </div>
            </div>
